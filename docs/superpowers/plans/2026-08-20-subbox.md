...
- [ ] **Step 3: Implement `subscription.py`**
...
- [ ] **Step 4: Create the shipped domain lists**
...
- [ ] **Step 4: Wire the bare invocation into the CLI**
...
- [ ] **Step 3: Verify the install into a throwaway prefix**
...
- [ ] **Step 4: Verify uninstall leaves user data alone**
...
- [ ] **Step 1: Write `packaging/PKGBUILD`**
...
- [ ] **Step 2: Verify the PKGBUILD parses**
...
- [ ] **Step 3: Write `integrations/claude-code/claude`**
...
- [ ] **Step 4: Write `integrations/claude-code/subbox-proxy-ensure.sh`**
...
- [ ] **Step 1: Generate `examples/config.toml` from the code**
...
- [ ] **Step 5: Write `docs/architecture.md` and `CHANGELOG.md`**
...
- [ ] **Step 2: Verify the suite passes locally the way CI will run it**
