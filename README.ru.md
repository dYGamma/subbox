...
![Дашборд subbox: состояние сервисов, нода, несущая трафик, и панель лога](docs/screenshot.png)
...
- Бинарь `sing-box` — установщик умеет скачать его сам

Больше ничего. Ни `pip`, ни средств сборки, ни пакетов Python: subbox — чистая
стандартная библиотека, а установка сводится к копированию файлов и генерации
launcher'а.
...
Debian, Ubuntu, Fedora и openSUSE **не пакуют** `sing-box`. Либо действуйте по
[официальной странице установки](https://sing-box.sagernet.org/installation/),
либо дайте установщику положить официальный статический бинарь в ваш префикс,
без root:
